...
<form method="POST" action="{{route('facultad.update',$facultad->codFacultad)}}" id="frmEditarFacultad" name="frmEditarFacultad">
    @csrf @method('PUT')
            ...
            <div class="col">
                <div class="card-body" style="padding-top: 2%; padding-bottom: 5%; padding-left: 5%">
                    <div class="col">
                        ...
                        <div class="col">
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{$facultad->nombre}}">
                        </div>
                    </div> 
                </div>
            </div>
...
<script type="text/javascript"> 
    ...
    function clickGuardar() 
    {
        ...
        document.frmEditarFacultad.submit(); // enviamos el formulario	
    }
